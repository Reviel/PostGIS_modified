 ...
 * liblwgeom versions
 */
#define LIBLWGEOM_VERSION "3.4.1"
#define LIBLWGEOM_VERSION_MAJOR "3"
#define LIBLWGEOM_VERSION_MINOR "4"
#define LIBLWGEOM_GEOS_VERSION "31200"
...
extern int lwgeom_interrupt_state(void);
...
{
	void* yyg;
	void* wkt_yy_buf_state; //(type YY_BUFFER_STATE)
	LWGEOM_PARSER_RESULT parser_result;
	YYLTYPE wkt_yylloc;
	void* geos_ctx;
	void* pj_ctx;
...
extern LWGEOM_CONTEXT* lwcontext();
...
#ifdef WIN32
#define strtok_sr strtok_s 
#else
#define strtok_sr strtok_r
#endif
