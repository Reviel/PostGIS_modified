...
#define global_parser_result 	(lwcontext()->parser_result)
#define wkt_yy_buf_state 		(lwcontext()->wkt_yy_buf_state)
#define wkt_yyg			 		(lwcontext()->yyg)
#define wkt_yylloc				(lwcontext()->wkt_yylloc)


/*
* Prototypes for the lexer
*/
extern void wkt_lexer_init(char* src, void** yyscanner);
extern void wkt_lexer_close(void* yyscanner);
extern int wkt_yylex_destroy(void* yyscanner);
