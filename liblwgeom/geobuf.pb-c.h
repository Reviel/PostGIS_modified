...
typedef struct Data__Feature Data__Feature;
typedef struct Data__Geometry Data__Geometry;
typedef struct Data__FeatureCollection Data__FeatureCollection;
typedef struct Data__Value Data__Value;
...
typedef enum {
  ...
  DATA__FEATURE__ID_TYPE_INT_ID = 12
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(DATA__FEATURE__ID_TYPE__CASE)
} Data__Feature__IdTypeCase;

struct  Data__Feature
{
...
struct  Data__FeatureCollection
{
  ProtobufCMessage base;
  size_t n_features;
...
typedef enum {
  ...
  DATA__VALUE__VALUE_TYPE_JSON_VALUE = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(DATA__VALUE__VALUE_TYPE__CASE)
...
typedef enum {
  ...
  DATA__DATA_TYPE_GEOMETRY = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(DATA__DATA_TYPE__CASE)
} Data__DataTypeCase;
